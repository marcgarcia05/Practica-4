...
function mostrar() {
    $rpp = 5;
    $totalArticulos = obtenirTotalArticlesUsuari($_SESSION['userID']);
    $totalPaginas = ceil($totalArticulos / $rpp);
    ...
    $offset = ($paginaActual - 1) * $rpp;
    $resultats = obtenirArticlesUsuariPaginats($offset, $rpp, 1);
        ...
        if(count($resultats) > 0){
            foreach ($resultats as $row) {
                $missatge .= "<div class='col mt-3'><div class='card' style='width: 18rem;'>\n<div class='card-body'>\n
                            ...
                            <button formAction='../Controlador/modificar.php' type='submit' name='modificar' value='". $row['ID'] ."' class='btn btn-warning'><svg xmlns='http://www.w3.org/2000/svg' width='16' height='16' fill='currentColor' class='bi bi-pencil-square' viewBox='0 0 16 16'>
