...
if(isset($_SESSION['username'])){
    ...
    <form action='../Controlador/controlador.php' method='post' class='form-inline justify-content-arround'>
        <button class='btn btn-outline-light mx-2' type='submit' name='login' value='signin'>Login</button>
        <button class='btn btn-outline-light mx-2' type='submit' name='signup' value='signup'>SignUp</button>
    </form>
</nav>";
}
?>